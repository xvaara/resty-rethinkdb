...
build = {
  ...
  modules = {
    ...
    ['rethinkdb.current_handshake'] = 'src/rethinkdb/current_handshake.lua',
    ['rethinkdb.handshake'] = 'src/rethinkdb/handshake.lua',
    ['rethinkdb.int_to_bytes'] = 'src/rethinkdb/int_to_bytes.lua',
    ['rethinkdb.protocol'] = 'src/rethinkdb/protocol.lua',
